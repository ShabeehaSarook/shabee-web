...
$sql = "SELECT * FROM menu_items"; // Use the correct table name 'menu_item'
...
<form action="menu.php" method="GET" style="text-align: center; margin: 20px;">
...
<div class="order-button">
    <i class="fas fa-shopping-cart"></i>  <a href="order.php">Order Now</a>
</div>
<div  class="promotion-button">
    <i class="fas fa-gift"></i> <a href="promotion.php">Promotions</a>
</div>
<script>
  
  document.getElementById('searchInput').addEventListener('keyup', function() {
    let searchTerm = this.value.toLowerCase();
    let menuItems = document.querySelectorAll('.item'); // Select all menu items

    menuItems.forEach(function(item) {
        let itemName = item.querySelector('.item-name').textContent.toLowerCase(); // Get the name of the menu item
