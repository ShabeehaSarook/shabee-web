...
<head>
  ...
  <title>Customer Login - The Gallery Café</title>
...
<body>
  ...
  <div class="login-box">
    ...
    <form id="loginForm" action="customer_login.php" method="post">
      <div>
  ...
  <script>
    document.getElementById('loginForm').addEventListener('submit', function(event) {
      ...
      if (isValid) {
        ...
        .then(data => {
          if (data.success) {
            window.location.href = 'customer_home.html'; // Redirect to customer home page
          } else {
